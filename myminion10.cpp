...
Myminion10::Myminion10(QGraphicsItem *parent)
{
    QPixmap p;p.load(":/image/character10.png");
...
void Myminion10::fire()
{
    Myminions::fire();
}
void Myminion10::move()
{
    if(pos().x()>1600&&pos().y()>350)setPos(x(),y()-10);
    else if(pos().x()>1600&&pos().y()<350)setPos(x(),y()+10);
    else setPos(x()+10,y());
}
