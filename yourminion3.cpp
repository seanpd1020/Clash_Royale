...
Yourminion3::Yourminion3(QGraphicsItem *parent)
{
...
void Yourminion3::fire()
{
    Yourminions::fire();
}
void Yourminion3::move()
{
    if(pos().x()<250&&pos().y()>350)setPos(x(),y()-9);
    else if(pos().x()<250&&pos().y()<350)setPos(x(),y()+9);
    else setPos(x()-9,y());
}
