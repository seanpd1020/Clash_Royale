...
Yourminion4::Yourminion4(QGraphicsItem *parent)
{
...
void Yourminion4::fire()
{
    Yourminions::fire();
}
void Yourminion4::move()
{
    if(pos().x()<250&&pos().y()>350)setPos(x(),y()-15);
    else if(pos().x()<250&&pos().y()<350)setPos(x(),y()+15);
    else setPos(x()-15,y());
}
