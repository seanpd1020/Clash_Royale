...
Yourminions::Yourminions(QGraphicsItem *parent):QObject(), QGraphicsPixmapItem(parent)
{
...
double Yourminions::distance(QGraphicsItem *item)
{
    QLineF ln(this->pos(),item->pos());
    return ln.length();
}
void Yourminions::fire()
{
